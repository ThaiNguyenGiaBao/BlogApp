...
function DashboardComponent() {
  ...
  useEffect(() => {
    //fetch data
    axios
      .get("http://14.225.192.183/api/user/get-metrics", {
        headers: {
    ...
    axios
      .get("http://14.225.192.183/api/comment/get-metrics", {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
      })
    ...
    axios
      .get("http://14.225.192.183/api/post/get-metrics", {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
      })
    ...
    axios
      .get("http://14.225.192.183/api/comment/getcomments")
      .then((res) => {
        console.log(res.data);
